"""
Django settings for django_development project.
...
SECRET_KEY = '=^$mexm3n2!h*a8(kj&r2!01v$gl9+ac*)*$b(u1(il4r1)py!'
...
ROOT_URLCONF = 'django_development.urls'  # 指定根路由
...
WSGI_APPLICATION = 'django_development.wsgi.application'
